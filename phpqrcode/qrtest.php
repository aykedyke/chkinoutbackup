 ...
 */
   ...
   ?>
	...
	<?php echo $PNG_WEB_DIR.basename($filename);  ?>
    <form action="qrtest.php" method="post">
        Data:&nbsp;<input name="data" value="<?php echo(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'PHP QR Code :)')?>" />&nbsp;
