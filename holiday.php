...
<body>
	...
	<div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                    <li onclick = "add_department()"><a href="javascript:void" title=""><img src="images/icons/control/32/hire-me.png" alt="" /><span>Add Holiday Work</span></a></li>
				</ul>
                <div class="clear"></div>
            </div>
        </div>
			...
			<fieldset>
                <div class="widget">
					...
					<div class="formRow">
                        ...
                        <div class="formRight"><input style = "width:150px" type="text" class="validate[required]" name="hours" id="hours"/>
						</div>
						<div class="clear"></div>
                    </div>
					<div class="formRow">
