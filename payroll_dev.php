...
<body>
    ...
    <div class="wrapper">
		...
		<a href = "publish_computed_payroll.php?id=<?php echo $cutoff_id;?>"> <input onclick="return confirm('Are you sure you want to publish the payroll?');" type="button" name = "publish" value="PUBLISH" class="blueB" /></a>
		 <br>
		 <br>
		<div class="table_container" style = "width:100%;overflow-x:scroll;">
		<div class="table_wrapper" 	 style = "width:3957px;">
		<div class="table_det">
			<ul class = "headul">
							...
							<li class="head">Late/Absent Hours</li>
