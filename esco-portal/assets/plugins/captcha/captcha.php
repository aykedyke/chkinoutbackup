...
class SimpleCaptcha {
     ...
     */
    public $fonts = array(
        //'Antykwa'  => array('spacing' => -3, 'minSize' => 16, 'maxSize' => 19, 'font' => 'AntykwaBold.ttf'),
        //'Candice'  => array('spacing' =>-1.5,'minSize' => 28, 'maxSize' => 31, 'font' => 'Candice.ttf'),
        //'DingDong' => array('spacing' => -2, 'minSize' => 24, 'maxSize' => 30, 'font' => 'Ding-DongDaddyO.ttf'),
        //'Duality'  => array('spacing' => -2, 'minSize' => 30, 'maxSize' => 38, 'font' => 'Duality.ttf'),
        'Heineken' => array('spacing' => -2, 'minSize' => 18, 'maxSize' => 18, 'font' => 'Heineken.ttf'),
    ...
    protected function ReduceImage() {
        ...
        imagecopyresampled($imResampled, $this->im, 0, 0, 0, 1, $this->width, $this->height,$this->width*$this->scale, $this->height*$this->scale);
        imagedestroy($this->im);
        $this->im = $imResampled;
    }
    /**
