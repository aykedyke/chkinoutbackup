...
<body>
    ...
    <div class="wrapper">
	   ...
	   ?>
	   <div class="widget">
            <div class="title"><img src="images/icons/dark/full2.png" alt="" class="titleIcon" /><h6 style = "color:white;">Deactivated Devices</h6></div>
            ...
            <tbody>
			<?php
				$emp_qry = mysql_query("SELECT * FROM tbl_firstregister WHERE company_id = '".$_SESSION['company']."' AND deactivate = '1'");
			...
			?>
					<tr>
						...
						<td><center><a onclick = "return confirm('Are you sure you want to activate?');" href = "activate_register.php?id=<?php echo $row_emp['firstregister_id']; ?>">Activate</a></center></td>
					</tr>
			<?php
				}
			}
