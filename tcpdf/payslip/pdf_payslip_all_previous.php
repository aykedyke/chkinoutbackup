...
$from_to_query = mysql_query("SELECT * FROM tbl_payslip WHERE payslip_id='16'");
while($row_from_to = mysql_fetch_array($from_to_query)){
...
$html ='';
				...
				$qry_log = mysql_query("SELECT * FROM tbl_employee");
...
<div style="text-align:left">
	Prepared by: <br/> <img width = "100px" src = "sig.png" /><br/>
	Christian Ramirez <br/>
